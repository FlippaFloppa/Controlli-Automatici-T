...
\begin{figure}[!h]
\centering
\includegraphics[width=1\textwidth]{sistema.png}
...
\begin{figure}[!h]
   \begin{minipage}{0.60\textwidth}
     \centering
     \includegraphics[width=1\textwidth]{misura.png}
   \end{minipage}\hfill
   \begin{minipage}{0.45\textwidth}
     \centering
     \includegraphics[width=1\textwidth]{uscita.png}
   \end{minipage}
\end{figure}
...
\begin{figure}[!h]
   \begin{minipage}{0.5\textwidth}
     \centering
     \includegraphics[width=1.03\textwidth]{x1_1.png}
     \caption*{$x_1\longrightarrow x_{1e}=3\cdot10^7$}
   \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
     \centering
     \includegraphics[width=1.1\textwidth]{x3_1.png}
...
\begin{figure}[!h]
    \centering
     \includegraphics[width=0.7\textwidth]{x3_1.png}
